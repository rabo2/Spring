...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public void login(String id, String pwd) throws SQLException, InvalidPasswordException, NotFoundIDException {
	...
	@Override
	public int getSearchMemberListCount(SearchCriteria cri) throws SQLException {
		return 0;
	}
